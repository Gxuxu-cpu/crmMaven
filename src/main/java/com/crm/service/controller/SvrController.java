...
public class SvrController {
	...
	@RequestMapping("/list")
	public String list(PageInfo<CstService> pageInfo, CstService cstService, Model model) {
	...
	@RequestMapping("/deal")
	public String deal(PageInfo<CstService> pageInfo, CstService cstService, Model model) {
		pageInfo.setEntity(cstService);
	...
	public String feedback(PageInfo<CstService> pageInfo, CstService cstService, Model model) {
		pageInfo.setEntity(cstService);
	...
	@RequestMapping("/arch")
	public String arch(PageInfo<CstService> pageInfo, CstService cstService, Model model) {
		pageInfo.setEntity(cstService);
		PageInfo<CstService> info = svrService.findListByPageInfo(pageInfo);
		model.addAttribute("typeList", svrService.selectByParam("服务类型"));
		model.addAttribute("Statusl", svrService.selectByParam("状态"));
